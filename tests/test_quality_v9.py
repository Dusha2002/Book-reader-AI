...
import chapter_reference_translation_v9b as v9
...
def test_dialogue_formatter_does_not_create_unbalanced_guillemets():
    ...
    value, _ = v9.v9._format_dialogue_v9(source, "'Нет,' — сказал он. 'Не сегодня.'")
...
def test_narrative_paired_quotes_become_safe_guillemets():
    ...
    value, _ = v9.v9._format_dialogue_v9(source, 'Он называл это "необходимым злом".')
